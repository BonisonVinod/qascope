                ...
                <div className="rounded bg-zinc-950/60 p-2.5 mt-2 border border-zinc-800 text-[10px] text-zinc-400 space-y-2 font-mono">
                  ...
                  <div className={`p-1.5 rounded ${isPlanACheaper ? "bg-teal-950/30 border border-teal-800/40" : ""}`}>
                    ...
                    <div className="text-[9px] text-zinc-500 mt-0.5">
                      ₹799/agent × {agents} agents + ₹{Math.round(conversations * apiUnitCost).toLocaleString("en-IN")} cloud processing
                    </div>
                  </div>
                  ...
                  <div className={`p-1.5 rounded ${!isPlanACheaper ? "bg-teal-950/30 border border-teal-800/40" : ""}`}>
                    ...
                    <div className="text-[9px] text-zinc-500 mt-0.5">
                      ₹4,999 flat platform + ₹1.50/convo (₹{Math.round(conversations * 1.50).toLocaleString("en-IN")} usage + ₹{Math.round(conversations * apiUnitCost).toLocaleString("en-IN")} infra)
                    </div>
                  </div>
                </div>
              </div>
